...
*
* modified-By: Osycle@gmail.com
*	modified-date: 2018-02-11
*/


var panaAccordion= {

	width:  $(".pana-accordion").width(),
	itemLen:  $(".pana-accordion-item").length,

	splitItemWidth: function( options ) {
		if( options.expandWidth )
		return ( this.width-options.expandWidth ) / ( this.itemLen-1 );
	},
	init: function(options){
		var that=this;
		options = $.extend(true,{
			expandWidth: 500,
			itemWidth: this.splitItemWidth( options ) || 100, //default 100
			extpand: 0,
			autoPlay: true,
			delay: 3000,
			animateTime: 400,
